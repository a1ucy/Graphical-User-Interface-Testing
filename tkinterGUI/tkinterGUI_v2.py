...
def usr_signup():
    ...
    signup_canvas =tk.Canvas(window_signup, height=250, width=300)
    ...
    #checkbox
    global c2
    c2 = tk.Button(window_signup, text='I have read and agree to the terms and conditions')
    c2.place(x=50, y=170)
...
def usr_forget():
    ...
    c3.place(x=100, y=180)
    
    #slidebar
    global forget_slider
    tk.Label(window_forget, text="Satisfaction Level").place(x=50, y=280)
    forget_slider = Scale(window_forget, from_=1, to=100, orient=tk.HORIZONTAL)  
...
btn_signup = tk.Button(window, text='Sign Up', command = usr_forget)
